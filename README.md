...
This initial version intentionally has no directory picker.

| Purpose | Directory |
| --- | --- |
| Game mod installation | `E:\Neverness To Everness\Client\WindowsNoEditor\HT\Content\Paks\~mods` |
| Mod backups | `E:\Neverness To Everness\Mods\Backups` |
